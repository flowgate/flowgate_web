...
long find_connected(long **G, long num_dense_grids, long ndim, long *grid_clusterID);

/************* Read basic info of the source file ****************************/
void getfileinfo(FILE *f_src, long *file_Len, long *num_dm, char *name_string)
{
  char src[LINE_LEN];
...
void readsource(FILE *f_src, long file_Len, long num_dm, double **uncomp_data)
{
...
long merge_clusters(long num_clust, long num_dm, double *interval, double **cluster_center, long *cluster_populationID, int max_num_pop)
{
...
*/
  ...
  */
  ...
  fprintf(f_parameters,"Bins=%ld\n",num_bin);
  fprintf(f_parameters,"Density=%d\n",den_t_event);
  fprintf(f_parameters,"Min=%d\n",min);
  fprintf(f_parameters,"Max=%d\n",max);
  fprintf(f_parameters,"Populations=%ld\n",num_population);
  fprintf(f_parameters,"Events=%ld\n",file_Len);
  fprintf(f_parameters,"TotalMarkers=%ld\n",num_dm);
  fprintf(f_parameters,"Markers=[%s]\n",para_name_string);
  fprintf(f_parameters,"Dots=%ld\n",num_nonempty);
  fclose(f_properties);
