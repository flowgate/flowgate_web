...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'File size is too large.(Max 2Gb)',//'The uploaded file exceeds the upload_max_filesize directive in php.ini',
        2 => 'File size is too large.(Max 2Gb)',//'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form',
    ...
    protected function upcount_name_callback($matches) {
        ...
        return '_'.$ext; //'('.$index.')'.$ext; //'_'.$index.$ext;
    }
